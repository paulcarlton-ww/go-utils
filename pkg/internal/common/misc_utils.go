...
// ErrCallerNotAvailable is an error returned when we can't obtain the caller.
var ErrCallerNotAvailable = errors.New("caller unavailable")
...
func Callers(levels uint, short bool) ([]string, error) {
	...
	if n == 0 {
		return nil, ErrCallerNotAvailable
	}
...
var sleepSecsFunc = sleepSecs // nolint:gochecknoglobals // ok
